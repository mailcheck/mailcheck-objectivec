#
# Be sure to run `pod spec lint Mailcheck-ObjectiveC.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of Mailcheck-ObjectiveC
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "David Kasper" => "dkasper@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'David Kasper', 'other author'
